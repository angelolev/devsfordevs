...
export const mockPosts: Post[] = [
  {
    id: '1',
    content: 'Just discovered this amazing TypeScript feature that automatically infers complex union types. Mind blown! 🤯',
  ...
  {
    id: '2',
    content: 'I hate PHP. There, I said it. The inconsistent function naming drives me crazy every single day.',
  ...
  {
    id: '3',
    content: 'Hot take: CSS Grid is better than Flexbox for 90% of layouts. Fight me! 😤',
  ...
  {
    id: '4',
    content: 'Finally understood closures in JavaScript after 2 years of web development. Better late than never! 📚',
...
export const mockComments: Comment[] = [
  ...
  {
    id: '2',
    content: 'Which feature specifically? I\'m always looking to learn more TS tricks.',
    author: mockUsers[2],
    postId: '1',
  ...
  {
    id: '5',
    content: 'PHP has its problems, but the ecosystem is solid. Laravel makes it bearable.',
    author: mockUsers[0],
    postId: '2',
  ...
  {
    id: '6',
    content: 'Laravel is great, but the language itself still has inconsistencies.',
    author: mockUsers[1],
    postId: '2',
    parentId: '5',
